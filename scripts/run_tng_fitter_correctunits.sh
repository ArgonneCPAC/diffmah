...
mpirun -n 100 python tng_diffmah_fitter_script_correctunits.py /lcrc/project/halotools/alarcon/data/ /lcrc/project/halotools/alarcon/results/tng_diffmah_tpeak_correctunits/
