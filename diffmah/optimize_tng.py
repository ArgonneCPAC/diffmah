...
BOUNDS = OrderedDict(
    frac_late_ylo=(0.55, 0.75),
    frac_late_yhi=(0.55, 0.75),
    mean_lge_early_ylo=(0.3, 0.5),
    mean_lge_early_yhi=(0.6, 0.75),
    mean_lgl_early_ylo=(-1.25, -0.8),
    mean_lgl_early_yhi=(0.7, 0.9),
    mean_lgtc_early_ylo=(-0.75, -0.25),
    mean_lgtc_early_yhi=(-0.25, -0.025),
    cov_lge_lge_early_ylo=(-0.75, -0.5),
    cov_lge_lge_early_yhi=(-1.0, -0.4),
    ...
    mean_lgl_late_ylo=(-1.8, -1.0),
    mean_lgl_late_yhi=(0.7, 1.3),
    mean_lgtc_late_ylo=(0.35, 0.55),
    mean_lgtc_late_yhi=(0.5, 0.9),
    cov_lge_lge_late_ylo=(-1.25, -0.7),
    cov_lge_lge_late_yhi=(-1.5, -1.0),
    cov_lgl_lgl_late_ylo=(-0.4, -0.05),
    cov_lgl_lgl_late_yhi=(-0.7, -0.4),
    cov_lgtc_lgtc_late_ylo=(-1.0, -0.6),
    cov_lgtc_lgtc_late_yhi=(-0.8, -0.4),
