...
DEFAULT_MAH_PDF_PARAMS = OrderedDict(
    frac_late_ylo=0.35,
    frac_late_yhi=0.45,
    mean_ue_early_ylo=0.70,
    mean_ue_early_yhi=3.50,
    mean_ul_early_ylo=-0.40,
    mean_ul_early_yhi=-0.40,
    mean_lgtc_early_ylo=-0.39,
    mean_lgtc_early_yhi=0.91,
    chol_ue_ue_early_ylo=0.10,
    chol_ue_ue_early_yhi=-0.25,
    chol_ul_ul_early_ylo=-0.25,
    chol_ul_ul_early_yhi=0.00,
    chol_lgtc_lgtc_early_ylo=-0.50,
    chol_lgtc_lgtc_early_yhi=-1.30,
    chol_ue_ul_early_ylo=-0.65,
    chol_ue_ul_early_yhi=-0.55,
    chol_ue_lgtc_early_ylo=0.00,
    chol_ue_lgtc_early_yhi=-0.15,
    chol_ul_lgtc_early_ylo=-0.13,
    chol_ul_lgtc_early_yhi=-0.25,
    mean_ue_late_ylo=0.50,
    mean_ue_late_yhi=2.81,
    mean_ul_late_ylo=-3.05,
    mean_ul_late_yhi=-1.65,
    mean_lgtc_late_ylo=0.16,
    mean_lgtc_late_yhi=1.90,
    chol_ue_ue_late_ylo=-0.20,
    chol_ue_ue_late_yhi=-0.70,
    chol_ul_ul_late_ylo=0.10,
    chol_ul_ul_late_yhi=-0.25,
    chol_lgtc_lgtc_late_ylo=-0.50,
    chol_lgtc_lgtc_late_yhi=-1.15,
    chol_ue_ul_late_ylo=-1.20,
    chol_ue_ul_late_yhi=0.50,
    chol_ue_lgtc_late_ylo=-0.20,
    chol_ue_lgtc_late_yhi=-0.03,
