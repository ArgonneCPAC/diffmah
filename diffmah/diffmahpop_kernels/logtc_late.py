...
LOGTC_PDICT = OrderedDict(
    logtc_lgm_c0_tp_ytp_tobs_c0_late=0.898,
    logtc_lgm_c0_tp_ytp_tobs_c1_late=0.005,
    logtc_lgm_c0_tp_ylo_late=0.118,
    logtc_lgm_c0_tp_yhi_late=-0.006,
    logtc_lgm_c1_late=0.146,
    logtc_c0_ss_x0_late=11.091,
)
LOGTC_BOUNDS_PDICT = OrderedDict(
    logtc_lgm_c0_tp_ytp_tobs_c0_late=(0.2, 0.9),
    logtc_lgm_c0_tp_ytp_tobs_c1_late=(0.0, 0.05),
    logtc_lgm_c0_tp_ylo_late=(0.02, 0.15),
    logtc_lgm_c0_tp_yhi_late=(-0.25, 0.0),
    logtc_lgm_c1_late=(0.02, 0.15),
    logtc_c0_ss_x0_late=(11.0, 13.0),
)
...
def _pred_logtc_kern(params, lgm_obs, t_obs, t_peak):
    ...
    logtc = lgm_c0 + params.logtc_lgm_c1_late * (lgm_obs - TAUC_LGMP)
...
def _get_c0(params, t_peak, t_obs):
    ytp = (
        params.logtc_lgm_c0_tp_ytp_tobs_c0_late
        + params.logtc_lgm_c0_tp_ytp_tobs_c1_late * t_obs
    )
    ylo, yhi = params.logtc_lgm_c0_tp_ylo_late, params.logtc_lgm_c0_tp_yhi_late
    c0 = _sig_slope(
        t_peak, C0_SS_XTP, ytp, params.logtc_c0_ss_x0_late, C0_SS_K, ylo, yhi
    )
    return c0
