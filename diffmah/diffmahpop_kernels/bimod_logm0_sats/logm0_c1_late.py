...
DEFAULT_LGM0POP_C1_PDICT = OrderedDict(
    lgm0pop_c1_ytp_late_sats=0.005,
    lgm0pop_c1_ylo_late_sats=-0.014,
    lgm0pop_c1_clip_x0_late_sats=10.587,
    lgm0pop_c1_clip_ylo_late_sats=0.074,
    lgm0pop_c1_clip_yhi_late_sats=0.037,
    lgm0pop_c1_t_obs_x0_late_sats=3.781,
)
...
LGM0POP_C1_BOUNDS_DICT = OrderedDict(
    lgm0pop_c1_ytp_late_sats=(0.001, 0.1),
    lgm0pop_c1_ylo_late_sats=(-0.05, -0.001),
    lgm0pop_c1_clip_x0_late_sats=(4.0, 11.0),
    lgm0pop_c1_clip_ylo_late_sats=(0.02, 0.15),
    lgm0pop_c1_clip_yhi_late_sats=(0.001, 0.05),
    lgm0pop_c1_t_obs_x0_late_sats=(3.0, 10.0),
)
...
def _pred_c1_kern(params, t_obs, t_peak):
    pred_c1 = _sig_slope(
        t_obs,
        XTP,
        params.lgm0pop_c1_ytp_late_sats,
        params.lgm0pop_c1_t_obs_x0_late_sats,
        GLOBAL_K,
        params.lgm0pop_c1_ylo_late_sats,
        0.0,
    )

    clip = _sigmoid(
        t_peak,
        params.lgm0pop_c1_clip_x0_late_sats,
        CLIP_TP_K,
        params.lgm0pop_c1_clip_ylo_late_sats,
        params.lgm0pop_c1_clip_yhi_late_sats,
    )
