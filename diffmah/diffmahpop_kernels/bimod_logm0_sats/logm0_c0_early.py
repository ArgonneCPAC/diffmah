...
DEFAULT_LGM0POP_C0_PDICT = OrderedDict(
    lgm0pop_c0_ytp_early_sats=0.011,
    lgm0pop_c0_ylo_early_sats=-0.086,
    lgm0pop_c0_clip_c0_early_sats=0.516,
    lgm0pop_c0_clip_c1_early_sats=-0.056,
    lgm0pop_c0_t_obs_x0_early_sats=1.504,
)
...
LGM0POP_C0_BOUNDS_DICT = OrderedDict(
    lgm0pop_c0_ytp_early_sats=(0.01, 0.4),
    lgm0pop_c0_ylo_early_sats=(-0.15, -0.05),
    lgm0pop_c0_clip_c0_early_sats=(0.5, 0.9),
    lgm0pop_c0_clip_c1_early_sats=(-0.1, -0.01),
    lgm0pop_c0_t_obs_x0_early_sats=(1.5, 6.0),
)
...
def _pred_c0_kern(params, t_obs, t_peak):
    pred_c0 = _sig_slope(
        t_obs,
        XTP,
        params.lgm0pop_c0_ytp_early_sats,
        params.lgm0pop_c0_t_obs_x0_early_sats,
        GLOBAL_K,
        params.lgm0pop_c0_ylo_early_sats,
        0.0,
    )
    clip = (
        params.lgm0pop_c0_clip_c0_early_sats
        + params.lgm0pop_c0_clip_c1_early_sats * t_peak
    )
