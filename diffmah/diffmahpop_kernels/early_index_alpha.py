...
EARLY_INDEX_PDICT = OrderedDict(
    early_index_ylo_x0_alpha=6.072,
    early_index_ylo_ylo_alpha=3.018,
    early_index_ylo_yhi_alpha=1.517,
    early_index_yhi_ylo_alpha=3.204,
    early_index_yhi_yhi_alpha=2.774,
    early_index_yhi_x0_alpha=10.274,
    early_index_lgm_x0_alpha=13.504,
)
EARLY_INDEX_BOUNDS_PDICT = OrderedDict(
    early_index_ylo_x0_alpha=(1.0, 7.0),
    early_index_ylo_ylo_alpha=(1.0, 3.5),
    early_index_ylo_yhi_alpha=(0.5, 3.0),
    early_index_yhi_ylo_alpha=(2.0, 4.0),
    early_index_yhi_yhi_alpha=(1.5, 4.0),
    early_index_yhi_x0_alpha=(4.0, 13.0),
    early_index_lgm_x0_alpha=(12.0, 14.0),
)
...
def _pred_early_index_kern(params, lgm_obs, t_obs, t_peak):
    early_index_ylo = _get_early_index_ylo(
        params.early_index_ylo_x0_alpha,
        params.early_index_ylo_ylo_alpha,
        params.early_index_ylo_yhi_alpha,
        t_peak,
    )
    early_index_yhi = _get_early_index_yhi(
        params.early_index_yhi_x0_alpha,
        params.early_index_yhi_ylo_alpha,
        params.early_index_yhi_yhi_alpha,
        t_obs,
    )
    early_index = _sigmoid(
        lgm_obs,
        params.early_index_lgm_x0_alpha,
        EARLY_INDEX_K,
        early_index_ylo,
        early_index_yhi,
    )
