...
DEFAULT_COV_PDICT = OrderedDict(
    ...
    std_u_logtc_ylo=0.056,
    std_u_early_ylo=0.239,
    std_u_late_ylo=0.500,
    std_u_logm0_yhi=0.105,
    std_u_logtc_yhi=1.551,
    std_u_early_yhi=0.187,
    std_u_late_yhi=21.877,
    rho_logtc_logm0=0.300,
    rho_early_logm0=0.299,
    rho_early_logtc=-0.300,
    rho_late_logm0=0.299,
    rho_late_logtc=-0.300,
    rho_late_early=-0.300,
    cov_lgm_x0_logm0=13.788,
    cov_lgm_x0_logtc=13.102,
    cov_lgm_x0_early=11.529,
    cov_lgm_x0_late=13.996,
)
