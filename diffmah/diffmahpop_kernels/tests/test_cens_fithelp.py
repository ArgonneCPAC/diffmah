...
def test_loss_grads():
    ...
    lgt0 = np.log10(t_0)
    n_tarr = 100
    tarr = np.linspace(0.1, t_obs, n_tarr)
    t_peak = t_0
    ...
    for lgm_obs in lgmarr:
        ...
        target_frac_peaked = np.linspace(0, 0.5, n_tarr)
        args = (
            ...
            ran_key,
            lgt0,
            mean_log_mah - lgm_obs,
            std_log_mah,
            target_frac_peaked,
        )
        loss = cens_fithelp._loss_mah_moments_singlebin(*args)
