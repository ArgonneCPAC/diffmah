...
LATE_INDEX_PDICT = OrderedDict(
    late_index_x0_alpha=11.567,
    late_index_ylo_alpha=0.190,
    late_index_yhi_alpha=0.190,
)
LATE_INDEX_BOUNDS_PDICT = OrderedDict(
    late_index_x0_alpha=(11.5, 14.0),
    late_index_ylo_alpha=(0.01, 0.2),
    late_index_yhi_alpha=(0.01, 0.2),
)
...
def _pred_late_index_kern(params, lgm_obs):
    late_index = _sigmoid(
        lgm_obs,
        params.late_index_x0_alpha,
        LATE_INDEX_K,
        params.late_index_ylo_alpha,
        params.late_index_yhi_alpha,
    )
